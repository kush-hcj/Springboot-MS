  ...
  <div>
    ...
    >
      <el-row>
          ...
          <el-form-item v-if="ruleForm.shuliang" label="数量" prop="shuliang">
              <el-input v-model="ruleForm.shuliang" 
                placeholder="数量" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="盘点数量" prop="pandianshuliang">
          <el-input v-model="ruleForm.pandianshuliang" 
              placeholder="盘点数量" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.pandianshuliang" label="盘点数量" prop="pandianshuliang">
              <el-input v-model="ruleForm.pandianshuliang" 
                placeholder="盘点数量" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item v-if="type!='info'"  label="盘点情况" prop="pandianqingkuang">
          <el-select v-model="ruleForm.pandianqingkuang" placeholder="请选择盘点情况">
            <el-option
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.pandianqingkuang" label="盘点情况" prop="pandianqingkuang">
              <el-input v-model="ruleForm.pandianqingkuang" 
                placeholder="盘点情况" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="type!='info'" label="盘点日期" prop="pandianriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.pandianriqi" label="盘点日期" prop="pandianriqi">
