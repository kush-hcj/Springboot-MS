...
public class CangkuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		CangkuEntity user = cangkuService.selectOne(new EntityWrapper<CangkuEntity>().eq("zhanghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"cangku",  "仓库" );
    ...
    public R register(@RequestBody CangkuEntity cangku){
    	//ValidatorUtils.validateEntity(cangku);
    	CangkuEntity user = cangkuService.selectOne(new EntityWrapper<CangkuEntity>().eq("zhanghao", cangku.getZhanghao()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        CangkuEntity user = cangkuService.selectById(id);
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,CangkuEntity cangku, HttpServletRequest request){
