...
public class XiaoshoudingdanController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,XiaoshoudingdanEntity xiaoshoudingdan, HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("xiaoshoubu")) {
			xiaoshoudingdan.setGonghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,XiaoshoudingdanEntity xiaoshoudingdan, HttpServletRequest request){
        EntityWrapper<XiaoshoudingdanEntity> ew = new EntityWrapper<XiaoshoudingdanEntity>();
		PageUtils page = xiaoshoudingdanService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, xiaoshoudingdan), params), params));
        return R.ok().put("data", page);
    }
